                ...
                <Popover>
                  ...
                  <div class="media-body">
                      <p class="noti-details">
                        <span class="noti-title">Santosh:</span>  new message <span class="noti-title">
                          Lock leave for Jan 2022</span></p>
                      <p class="noti-time"><span class="notification-time">
                        45 mins ago</span></p></div>
                        <div class="media-body">
                      <p class="noti-details">
                        <span class="noti-title">Sunil:</span>  new message <span class="noti-title">
                          Jan 2022 locked for leaves</span></p>
                      <p class="noti-time"><span class="notification-time">
                       1 hrs ago</span></p></div>
                  </Popover.Body>
                </Popover>
              }>
                ...
                <Popover>
                  ...
                  <Popover.Body>
                    <div class="media-body">
                      <p class="noti-details">
                        <span class="noti-title">Santosh:</span>  new message <span class="noti-title">
                          Apply leave for Jan 2022</span></p>
                      <p class="noti-time"><span class="notification-time">
                        4 mins ago</span></p></div>
                        <div class="media-body">
                      <p class="noti-details">
                        <span class="noti-title">Sunil:</span>  new message <span class="noti-title">
                          Jan 2022 locked for leaves</span></p>
                      <p class="noti-time"><span class="notification-time">
                        30 mins ago</span></p></div>
                  </Popover.Body>
                </Popover>
              }>
              <Button className="popoverbutton">
